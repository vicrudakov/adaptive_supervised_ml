...
## Baselines 1
# Active learning baselines with the settings consistent to the main training experiments with continual active
# learning methods

## Baselines 2
# Single-iteration training on the full 100% of the training data with the settings consistent to the main training
# experiments with continual active learning methods
